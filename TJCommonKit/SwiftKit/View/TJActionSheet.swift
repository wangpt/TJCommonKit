...
@objc(TJActionSheet)
class TJActionSheet: UIViewController {
    ...
    public var otherSheetTitle: String?
    public var otherSheetTitleFont: UIFont?
    public var otherSheetTitleColor: UIColor?
    ...
    fileprivate let overlayBackgroundColor = UIColor(red:0, green:0, blue:0, alpha:0.3)
    fileprivate let reuseIdentifier = "TJTableViewCell"
    fileprivate let reuseIdentifier1 = "TJTableViewTitleCell"
    ...
    fileprivate func setup() {
        ...
        tableView.alpha = 0.7
        tableView.register(TJActionSheetCell.self, forCellReuseIdentifier: reuseIdentifier)
        tableView.register(TJActionSheetTitleCell.self, forCellReuseIdentifier: reuseIdentifier1)
...
extension TJActionSheet {
    ...
    fileprivate func setCancelButtonTextColorAndTextFont(cell: TJActionSheetCell) {
    ...
    fileprivate func setTextButtonTextColorAndTextFont(cell: TJActionSheetCell) {
        if textColor != nil {
    ...
    fileprivate func setTitleColorAndTextFont(cell: TJActionSheetTitleCell) {
...
extension TJActionSheet: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if hasTitle() {
            if  indexPath.section == 0 {
                let cell: TJActionSheetTitleCell = tableView.dequeueReusableCell(withIdentifier: reuseIdentifier1, for: indexPath) as! TJActionSheetTitleCell
                cell.titlelabel.text = self.actionSheetTitle
                setTitleColorAndTextFont(cell: cell)
                return cell
            }
            let cell: TJActionSheetCell = tableView.dequeueReusableCell(withIdentifier: reuseIdentifier, for: indexPath) as! TJActionSheetCell
...
extension TJActionSheet: UITableViewDelegate {
...
class TJActionSheetTitleCell: UITableViewCell {
    //MARK: - public property
